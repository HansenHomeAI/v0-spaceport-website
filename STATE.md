...
last_step: 2026-05-24T22:48:33Z Friday canonical run re-verified terminal (SfM/3DGS/compression Completed); SageMaker InProgress=0; S3 outputs present; public meta + viewer reachable; GH branch + exact-head snapshots recorded.
