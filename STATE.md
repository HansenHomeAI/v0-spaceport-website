...
last_step: 2026-05-25T17:45:42Z HMC canonical run re-verified terminal (SfM/3DGS/compression Completed); SageMaker InProgress=0/0; S3 outputs present (staging+prod); prod meta HTTP 200; hosted preview viewer base/sky/no-sky HTTP 200; GH branch+exact-head snapshots captured (head is [skip ci]); evidence stamp 20260525T174542Z recorded in logs/montana-time-capsule/.
