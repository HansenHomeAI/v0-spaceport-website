...
last_step: 2026-05-21T09:55Z polled SageMaker job `hmc-mtc-20260520T2015Z-sfm` (still InProgress; CloudWatch lastEvent still 2026-05-21T00:01:36.365Z; output prefix KeyCount=0), refreshed `logs/montana-time-capsule/hmc-state.json` (no launch). Details in logs/montana-time-capsule/STATE.md.
