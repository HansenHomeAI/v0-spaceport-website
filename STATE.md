...
last_step: 2026-05-21T12:17Z pushed latest SfM poll artifacts (head [skip ci]; exact-head GH runs=0) without launching any new jobs. Details in logs/montana-time-capsule/STATE.md.
