...
live_compute_status: SageMaker training job md1-r2-pair-1776991746-tiled failed during tile_02 eval at step 2900 with CUDA OOM; bounded retry md1-r2-evalskip-1776995639-tiled is InProgress/Training on tile_02 after scaffold success, with eval metrics suppressed and no fidelity/downscale reduction; no full-scene training spend active
current_branch: agent-53821974-md1-geometry-consistency
current_head_at_state_write: 031daffe123bc63d389ef7972169caaec5863691
...
exact_artifacts:
  ...
  active_r2_training_job: md1-r2-evalskip-1776995639-tiled
  active_r2_output_root: s3://spaceport-ml-processing-staging/manual-validations/md1-geometry-consistency-r2-evalskip-20260424015359/3dgs
  ...
  r2_retry_checkpoint_head: 031daffe123bc63d389ef7972169caaec5863691
  ...
  preview_hash_url: https://45d5dcff.v0-spaceport-website-preview2.pages.dev
...
review_gate_delta:
  ...
  checkpoint_workflows_green: CDK 24868457630 and Pages 24868463286 green for 031daffe; preview hash https://45d5dcff.v0-spaceport-website-preview2.pages.dev
  r2_retry_current_signal: CloudWatch confirms md1-r2-evalskip-1776995639-tiled completed global_scaffold training/export, then started tile_02 leaf_tile training at 2026-04-24T02:16:44Z with 188 selected images, 12000 max iterations, and eval image/all-image steps set to 12001; no output artifact yet
