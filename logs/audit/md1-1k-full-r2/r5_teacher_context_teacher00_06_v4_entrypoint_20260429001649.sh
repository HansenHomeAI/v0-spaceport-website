...
python3 /opt/ml/processing/input/scripts/build_md1_hybrid_artifact.py \
  ...
  --label r5_teacher_context_teacher00_06_v4 \
  --purpose 'Repair remaining R5 horizon smoke regression by restoring the full promoted teacher/context tile_00 through tile_06 set while keeping R5 tile_07 through tile_13 before any promotion.' \
