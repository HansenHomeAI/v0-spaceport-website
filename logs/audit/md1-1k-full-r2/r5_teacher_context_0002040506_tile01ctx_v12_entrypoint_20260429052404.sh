...
python3 /opt/ml/processing/input/scripts/build_md1_hybrid_artifact.py \
  ...
  --label r5_teacher_context_0002040506_tile01ctx_v12 \
  --purpose 'Start from V8 best tile_00/tile_02/tile_04/tile_05/tile_06 teacher repair, keep opacity unchanged, and preserve historical R5 tile_01 context bounds because p24 horizon smoke cameras are owned by tile_01/tile_04 and V8 dropped 98327 tile_01 gaussians.' \
