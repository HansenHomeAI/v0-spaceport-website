...
python3 /opt/ml/processing/input/scripts/build_md1_hybrid_artifact.py \
  ...
  --label r5_teacher_context_0002040506_v8 \
  --purpose 'Repair remaining R5 horizon smoke regression by adding promoted teacher/context tile_05 to the best-so-far V6 tile_00/tile_02/tile_04/tile_06 repair while still excluding V5 tile_01 and non-helpful V7 tile_03.' \
