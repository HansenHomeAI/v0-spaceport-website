...
python3 /opt/ml/processing/input/scripts/build_md1_hybrid_artifact.py \
  ...
  --label r5_teacher_context_0002030406_v7 \
  --purpose 'Repair remaining R5 horizon smoke regression by adding promoted teacher/context tile_03 to the V6 tile_00/tile_02/tile_04/tile_06 repair while still excluding V5 tile_01.' \
