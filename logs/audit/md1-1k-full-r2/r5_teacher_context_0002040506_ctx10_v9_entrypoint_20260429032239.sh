...
python3 /opt/ml/processing/input/scripts/build_md1_hybrid_artifact.py \
  ...
  --label r5_teacher_context_0002040506_ctx10_v9 \
  --purpose 'Repair remaining R5 horizon smoke regression by keeping V8 teacher tile_00/tile_02/tile_04/tile_05/tile_06 and adding 10 percent context padding to preserve a little more teacher horizon support.' \
