...
python3 /opt/ml/processing/input/scripts/build_md1_hybrid_artifact.py \
  ...
  --label r5_teacher_context_00020406_v6 \
  --purpose 'Repair remaining R5 horizon smoke regression by adding promoted teacher/context tile_00 to the V3 tile_02/tile_04/tile_06 repair while excluding V5 tile_01, which worsened horizon PSNR/SSIM/LPIPS.' \
