...
python3 /opt/ml/processing/input/scripts/build_md1_hybrid_artifact.py \
  ...
  --force-overlap-tile tile_01 \
  --context-padding-ratio 0.0 \
  --merge-mode support_weighted_overlap \
  --label r5_teacher_context_v12_tile01overlap_v16 \
  --purpose 'Start from V12/V15 best blocked repair and force ownership of tile_01 overlap candidates to test whether dropped historical tile_01 horizon-owner gaussians close the remaining horizon PSNR-only miss.' \
