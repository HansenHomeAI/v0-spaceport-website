...
## 2026-05-22T15:34:10Z HEARTBEAT monitor (HMC) - terminal reconfirmed + S3 + viewer/proxy reachable + exact-head CI recorded (no launches)

- Git: agent-40136728-montana-time-capsule @ 028449b5b04925f636665c1c68b2499a0d6bcaac ([skip ci]) (status=logs/montana-time-capsule/git-head-status-20260522T153410Z.txt)
- AWS (us-west-2): logs/montana-time-capsule/aws-sts-get-caller-identity-20260522T153410Z.json (acct 975050048887) (region=logs/montana-time-capsule/aws-config-region-20260522T153410Z.txt)
- SageMaker:
  - SfM processing job: hmc-mtc-20260520T2015Z-sfm status=Completed (describe=logs/montana-time-capsule/sagemaker-describe-hmc-mtc-20260520T2015Z-sfm-20260522T153410Z.json)
  - 3DGS training job: hmc-mtc-20260520T2015Z-3dgs status=Completed (describe=logs/montana-time-capsule/sagemaker-describe-hmc-mtc-20260520T2015Z-3dgs-20260522T153410Z.json)
  - compression processing job: hmc-mtc-20260520T2015Z-compression status=Completed (describe=logs/montana-time-capsule/sagemaker-describe-hmc-mtc-20260520T2015Z-compression-20260522T153410Z.json)
  - InProgress lists: logs/montana-time-capsule/sagemaker-list-processing-jobs-inprogress-20260522T153410Z.json (0); logs/montana-time-capsule/sagemaker-list-training-jobs-inprogress-20260522T153410Z.json (0)
- S3 (supersplat bundle):
  - bundle listing: logs/montana-time-capsule/s3-ls-supersplat_bundle-20260522T153410Z.txt
  - bundle meta head-object: logs/montana-time-capsule/s3api-head-object-supersplat-meta-20260522T153410Z.json
  - bundle background skybox head-object: logs/montana-time-capsule/s3api-head-object-supersplat-background_skybox-webp-20260522T153410Z.json
- Hosted preview viewer reachability:
  - viewer URL (skybox): logs/montana-time-capsule/heartbeat-viewer-skybox-url-20260522T153410Z.txt (headers=logs/montana-time-capsule/curlI-viewer-skybox-20260522T153410Z.headers; HTTP 200)
  - viewer URL (no-sky): logs/montana-time-capsule/heartbeat-viewer-nosky-url-20260522T153410Z.txt (headers=logs/montana-time-capsule/curlI-viewer-nosky-20260522T153410Z.headers; HTTP 200)
  - proxy meta URL: logs/montana-time-capsule/heartbeat-proxy-meta-url-20260522T153410Z.txt (headers=logs/montana-time-capsule/curlI-proxy-meta-20260522T153410Z.headers; HTTP 200)
- CI:
  - exact-head runs: logs/montana-time-capsule/gh-run-list-exact-head-20260522T153410Z.json (0; expected due to [skip ci] head)
  - branch runs: logs/montana-time-capsule/gh-run-list-branch-20260522T153410Z.json
...
## 20260522T153607Z HEARTBEAT monitor (HMC) - terminal reconfirmed + S3 + viewer/proxy reachable + AWS/CI evidence captured (no launches)

- Git: agent-40136728-montana-time-capsule @ eacb7fda7a30a97d221b3d5ee2057c560bb48f2e (dirty=logs/STATE only)
- AWS (us-west-2): logs/montana-time-capsule/aws-sts-get-caller-identity-20260522T144443Z.json (region=logs/montana-time-capsule/aws-config-region-20260522T144443Z.txt)
- CI:
  - exact-head runs: logs/montana-time-capsule/gh-run-list-exact-head-20260522T144443Z.json
  - branch runs: logs/montana-time-capsule/gh-run-list-branch-20260522T144443Z.json
- SageMaker (terminal):
  - SfM: logs/montana-time-capsule/sagemaker-describe-hmc-mtc-20260520T2015Z-sfm-20260522T144501Z.json (Completed)
  - 3DGS: logs/montana-time-capsule/sagemaker-describe-training-hmc-mtc-20260520T2015Z-3dgs-20260522T144501Z.json (Completed)
  - compression: logs/montana-time-capsule/sagemaker-describe-hmc-mtc-20260520T2015Z-compression-20260522T144501Z.json (Completed)
...
- S3 (supersplat bundle): logs/montana-time-capsule/s3-ls-supersplat_bundle-20260522T144553Z.txt (13 objects); meta/skybox head-object: logs/montana-time-capsule/s3api-head-object-supersplat-meta-20260522T144553Z.json; logs/montana-time-capsule/s3api-head-object-supersplat-background_skybox-webp-20260522T144553Z.json
- Hosted viewer reachability (HTTP 200):
  - viewer skybox URL: logs/montana-time-capsule/heartbeat-viewer-skybox-url-20260522T153607Z.txt (headers=logs/montana-time-capsule/curlI-viewer-skybox-20260522T153607Z.headers)
  - viewer no-sky URL: logs/montana-time-capsule/heartbeat-viewer-nosky-url-20260522T153607Z.txt (headers=logs/montana-time-capsule/curlI-viewer-nosky-20260522T153607Z.headers)
  - proxy meta URL: logs/montana-time-capsule/heartbeat-proxy-meta-url-20260522T153607Z.txt (headers=logs/montana-time-capsule/curlI-proxy-meta-20260522T153607Z.headers)

Next: remain idle; only re-run viewer/screenshot gates if asked.
