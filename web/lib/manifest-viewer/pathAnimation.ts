...
function catmullRomVector(v0: V3, v1: V3, v2: V3, v3: V3, t: number, out: V3): void {
...
export function createInitialPathState(params: {
  ...
  return {
    ...
    speed: Number.isFinite(params.speed) && (params.speed as number) > 0 ? (params.speed as number) : 1,
...
export function updatePathAnimation(state: PathAnimationState, deltaSeconds: number): { ended: boolean } {
  let ended = false;
