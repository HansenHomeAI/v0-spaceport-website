...
export const meadowLaneManifest: ViewerManifest = {
  ...
  bundle: {
    ...
    preview: {
      metaUrl: "/viewer-previews/meadow-ln/preview-meta.json",
      pointSizeDesktop: 1.95,
      pointSizeMobile: 1.55,
      initialVisiblePointsDesktop: 0,
      initialVisiblePointsMobile: 0,
      revealDurationDesktopMs: 0,
      revealDurationMobileMs: 0,
      minimumDisplayDesktopMs: 1050,
      minimumDisplayMobileMs: 1200,
      revealChunkMetaCount: 2,
      revealChunkTextureCount: 8,
      fadeDelayDesktopMs: 140,
      fadeDelayMobileMs: 180,
      fadeDurationDesktopMs: 2200,
      fadeDurationMobileMs: 2400,
      skyboxFadeStart: 0.9,
    },
