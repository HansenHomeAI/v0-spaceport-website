...
export const meadowLaneManifest: ViewerManifest = {
  ...
  bundle: {
    ...
    preview: {
      ...
      pointSizeDesktop: 0.011,
      pointSizeMobile: 0.008,
      initialVisiblePointsDesktop: 900,
      initialVisiblePointsMobile: 450,
      revealDurationDesktopMs: 950,
      revealDurationMobileMs: 1250,
      fadeDelayDesktopMs: 300,
      fadeDelayMobileMs: 450,
      fadeDurationDesktopMs: 900,
      fadeDurationMobileMs: 1200,
    },
