...
export default function CameraOverlapPage() {
  ...
  const realPathOverlapConfig = useMemo(
    () => buildSpinPathOverlapConfig({
      ...
      speedEnvLoAglFt: speedEnvLoAgl,
      speedEnvLoMph: speedEnvLoMph,
      speedEnvHiAglFt: speedEnvHiAgl,
      speedEnvHiMph: speedEnvHiMph,
      captureSpacingFt: activeCaptureIntervalFt,
      captureIntervalSeconds: captureCadenceSec,
      captureIntervalUnit,
      captureDistanceIntervalFt: captureIntervalFt,
      captureTimeIntervalSeconds: captureIntervalSec,
      yawRateDegPerSec,
