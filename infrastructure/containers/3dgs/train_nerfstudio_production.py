...
class NerfStudioTrainer:
    ...
    def apply_step_functions_params(self):
        ...
        env_params = {
            ...
            'SKYBOX_PHOTOMETRIC_ALIGNMENT_STRENGTH': 'output.background_skybox.photometric_alignment_strength',
            'SKYBOX_BASE_SATURATION_SCALE': 'output.background_skybox.base_saturation_scale',
            'SKYBOX_DETAIL_LUMA_STRENGTH': 'output.background_skybox.detail_luma_strength',
            'SKYBOX_DETAIL_CHROMA_STRENGTH': 'output.background_skybox.detail_chroma_strength',
            'SKYBOX_DETAIL_HORIZON_MARGIN_PX': 'output.background_skybox.detail_horizon_margin_px',
            'SKYBOX_DETAIL_MASK_EROSION_PX': 'output.background_skybox.detail_mask_erosion_px',
        ...
        integer_envs = {
            ...
            'SKYBOX_DETAIL_HORIZON_MARGIN_PX',
            'SKYBOX_DETAIL_MASK_EROSION_PX',
            'SKYBOX_OBSERVED_BLUR_RADIUS_PX',
            'SKYBOX_DETAIL_BLUR_RADIUS_PX',
        ...
        float_envs = {
            ...
            'SKYBOX_PHOTOMETRIC_ALIGNMENT_STRENGTH',
            'SKYBOX_BASE_SATURATION_SCALE',
            'SKYBOX_DETAIL_LUMA_STRENGTH',
            'SKYBOX_DETAIL_CHROMA_STRENGTH',
            'SKYBOX_MIN_PROJECTED_ELEVATION',
    ...
    def export_trained_model(self, source_config: Optional[Path] = None) -> bool:
        ...
        if model_variant in {"splatfacto-w-light", "splatfacto-w"}:
            export_cmd = [
                ...
                "--skybox-photometric-alignment-strength", str(skybox_config.get('photometric_alignment_strength', 0.65)),
                "--skybox-base-saturation-scale", str(skybox_config.get('base_saturation_scale', 0.78)),
                "--skybox-detail-luma-strength", str(skybox_config.get('detail_luma_strength', 0.85)),
                "--skybox-detail-chroma-strength", str(skybox_config.get('detail_chroma_strength', 0.12)),
                "--skybox-detail-horizon-margin-px", str(skybox_config.get('detail_horizon_margin_px', 24)),
                "--skybox-detail-mask-erosion-px", str(skybox_config.get('detail_mask_erosion_px', 3)),
