...
def lambda_handler(event, context):
    ...
    try:
        ...
        default_hyperparameters = {
            ...
            "FLOATER_PRUNING_MIN_VIEWS": "4",
            "FLOATER_PRUNING_TOP_REGION_RATIO": "0.35",
            "FLOATER_PRUNING_TOP_VIEW_FRACTION": "0.8",
            "FLOATER_PRUNING_MAX_OPACITY": "0.25",
            "FLOATER_PRUNING_MAX_COLOR_DISTANCE": "0.12",
            "FLOATER_PRUNING_MIN_EDGE_SUPPORT": "2",
