...
def lambda_handler(event, context):
    ...
    try:
        ...
        default_hyperparameters = {
            ...
            "SKYBOX_PHOTOMETRIC_ALIGNMENT_STRENGTH": "0.65",
            "SKYBOX_BASE_SATURATION_SCALE": "0.76",
            "SKYBOX_DETAIL_LUMA_STRENGTH": "0.7",
            "SKYBOX_DETAIL_CHROMA_STRENGTH": "0.08",
            "SKYBOX_DETAIL_HORIZON_MARGIN_PX": "24",
            "SKYBOX_DETAIL_MASK_EROSION_PX": "3",
            "SKYBOX_MIN_PROJECTED_ELEVATION": "0.0",
            "SKYBOX_OBSERVED_BLUR_RADIUS_PX": "20",
            "SKYBOX_DETAIL_BLUR_RADIUS_PX": "10",
            "SKYBOX_FILL_EDGE_HORIZONTAL_BLUR_PX": "40",
            "SKYBOX_FILL_EDGE_VERTICAL_BLUR_PX": "120",
            "SKYBOX_SEAM_BLEND_WIDTH_PX": "56",
            "SKYBOX_DETAIL_BOUNDARY_FADE_PX": "32",
            "SKYBOX_DETAIL_NEGATIVE_LUMA_SCALE": "0.18",
