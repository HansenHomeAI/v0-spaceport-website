...
<head>
    <style>
        ...
        .container {{ background: white; border-radius: 25px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1); border: 3px solid rgba(128, 128, 128, 0.2); }}
...
<body>
    <div class="container">
        <div class="logo">
            <svg width="386" height="61" viewBox="0 0 386 61" fill="none" xmlns="http://www.w3.org/2000/svg">
