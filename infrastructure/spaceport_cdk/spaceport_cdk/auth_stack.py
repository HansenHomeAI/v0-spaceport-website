...
class AuthStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, env_config: dict, **kwargs) -> None:
        ...
        # Preserve the legacy deployment resource model for this API so updates keep
        # mutating the existing prod stage instead of trying to add a new Stage resource.
