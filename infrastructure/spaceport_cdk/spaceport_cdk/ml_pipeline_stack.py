        ...
        gaussian_job = sfn_tasks.CallAwsService(
            ...
            parameters={
                ...
                "Environment": {
                    ...
                    "ENABLE_SEMANTIC_SKY_MASKS": sfn.JsonPath.string_at("$.ENABLE_SEMANTIC_SKY_MASKS"),
                    "SEMANTIC_SKY_MODEL_ID": sfn.JsonPath.string_at("$.SEMANTIC_SKY_MODEL_ID"),
                    "SEMANTIC_SKY_CONFIDENCE_THRESHOLD": sfn.JsonPath.string_at("$.SEMANTIC_SKY_CONFIDENCE_THRESHOLD"),
                    "SEMANTIC_SKY_MIN_COMPONENT_AREA": sfn.JsonPath.string_at("$.SEMANTIC_SKY_MIN_COMPONENT_AREA"),
                    "SEMANTIC_SKY_FILL_HOLE_AREA": sfn.JsonPath.string_at("$.SEMANTIC_SKY_FILL_HOLE_AREA"),
                    "SEMANTIC_SKY_KEEP_TOP_CONNECTED_ONLY": sfn.JsonPath.string_at("$.SEMANTIC_SKY_KEEP_TOP_CONNECTED_ONLY"),
                    "SEMANTIC_SKY_TRAINING_MASK_MODE": sfn.JsonPath.string_at("$.SEMANTIC_SKY_TRAINING_MASK_MODE"),
                    ...
                    "ENABLE_PROJECTED_PHOTO_SKYBOX": sfn.JsonPath.string_at("$.ENABLE_PROJECTED_PHOTO_SKYBOX"),
                    "SKYBOX_COMPOSITION_MODE": sfn.JsonPath.string_at("$.SKYBOX_COMPOSITION_MODE"),
                    "SKYBOX_WORLD_UP_SOURCE": sfn.JsonPath.string_at("$.SKYBOX_WORLD_UP_SOURCE"),
                    "SKYBOX_MIN_SKY_MASK_RATIO": sfn.JsonPath.string_at("$.SKYBOX_MIN_SKY_MASK_RATIO"),
                    "SKYBOX_MIN_OBSERVATIONS_PER_PIXEL": sfn.JsonPath.string_at("$.SKYBOX_MIN_OBSERVATIONS_PER_PIXEL"),
                    "SKYBOX_BLEND_EDGE_FEATHER_PX": sfn.JsonPath.string_at("$.SKYBOX_BLEND_EDGE_FEATHER_PX"),
                    "SKYBOX_LOW_FREQUENCY_FILL": sfn.JsonPath.string_at("$.SKYBOX_LOW_FREQUENCY_FILL"),
                    "SKYBOX_PROJECTION_MAX_LONG_SIDE": sfn.JsonPath.string_at("$.SKYBOX_PROJECTION_MAX_LONG_SIDE"),
                    "SKYBOX_PROJECTION_MASK_MODE": sfn.JsonPath.string_at("$.SKYBOX_PROJECTION_MASK_MODE"),
                    "SKYBOX_PROJECTION_CONFIDENCE_THRESHOLD": sfn.JsonPath.string_at("$.SKYBOX_PROJECTION_CONFIDENCE_THRESHOLD"),
                    "SKYBOX_PROJECTION_HORIZON_SMOOTHING_PX": sfn.JsonPath.string_at("$.SKYBOX_PROJECTION_HORIZON_SMOOTHING_PX"),
                    "SKYBOX_PHOTOMETRIC_ALIGNMENT_STRENGTH": sfn.JsonPath.string_at("$.SKYBOX_PHOTOMETRIC_ALIGNMENT_STRENGTH"),
                    "SKYBOX_BASE_SATURATION_SCALE": sfn.JsonPath.string_at("$.SKYBOX_BASE_SATURATION_SCALE"),
                    "SKYBOX_DETAIL_LUMA_STRENGTH": sfn.JsonPath.string_at("$.SKYBOX_DETAIL_LUMA_STRENGTH"),
                    "SKYBOX_DETAIL_CHROMA_STRENGTH": sfn.JsonPath.string_at("$.SKYBOX_DETAIL_CHROMA_STRENGTH"),
                    "SKYBOX_DETAIL_HORIZON_MARGIN_PX": sfn.JsonPath.string_at("$.SKYBOX_DETAIL_HORIZON_MARGIN_PX"),
                    "SKYBOX_DETAIL_MASK_EROSION_PX": sfn.JsonPath.string_at("$.SKYBOX_DETAIL_MASK_EROSION_PX"),
                    "SKYBOX_MIN_PROJECTED_ELEVATION": sfn.JsonPath.string_at("$.SKYBOX_MIN_PROJECTED_ELEVATION"),
                    "SKYBOX_OBSERVED_BLUR_RADIUS_PX": sfn.JsonPath.string_at("$.SKYBOX_OBSERVED_BLUR_RADIUS_PX"),
                    "SKYBOX_DETAIL_BLUR_RADIUS_PX": sfn.JsonPath.string_at("$.SKYBOX_DETAIL_BLUR_RADIUS_PX"),
                    "SKYBOX_FILL_EDGE_HORIZONTAL_BLUR_PX": sfn.JsonPath.string_at("$.SKYBOX_FILL_EDGE_HORIZONTAL_BLUR_PX"),
                    "SKYBOX_FILL_EDGE_VERTICAL_BLUR_PX": sfn.JsonPath.string_at("$.SKYBOX_FILL_EDGE_VERTICAL_BLUR_PX"),
                    "SKYBOX_SEAM_BLEND_WIDTH_PX": sfn.JsonPath.string_at("$.SKYBOX_SEAM_BLEND_WIDTH_PX"),
                    "SKYBOX_DETAIL_BOUNDARY_FADE_PX": sfn.JsonPath.string_at("$.SKYBOX_DETAIL_BOUNDARY_FADE_PX"),
                    "SKYBOX_DETAIL_NEGATIVE_LUMA_SCALE": sfn.JsonPath.string_at("$.SKYBOX_DETAIL_NEGATIVE_LUMA_SCALE"),
