...
class SpaceportStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # -------------------------------------
        # New production-ready User Pool (v2)
        # Create as a brand new resource to avoid immutable updates
        # -------------------------------------
        ...
        beta_group_v2 = cognito.CfnUserPoolGroup(
            self,
        ...
        invite_res_v2.add_method(
            "POST",
            apigw.LambdaIntegration(invite_lambda_v2, proxy=True)
        )
