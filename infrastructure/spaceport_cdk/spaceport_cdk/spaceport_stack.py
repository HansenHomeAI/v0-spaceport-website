...
class SpaceportStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, env_config: dict, **kwargs) -> None:
        ...
        self.feedback_lambda = lambda_.Function(
            ...
            environment={
                "RESEND_API_KEY": os.environ.get("RESEND_API_KEY", ""),
                "FEEDBACK_RECIPIENTS": "gabriel@spcprt.com,ethan@spcprt.com,hello@spcprt.com",
                "FEEDBACK_FROM_EMAIL": os.environ.get("FEEDBACK_FROM_EMAIL", "Spaceport AI <hello@spcprt.com>"),
                "FEEDBACK_SUBJECT": os.environ.get("FEEDBACK_SUBJECT", "Spaceport AI Website Feedback"),
            }
        )
    ...
    def _create_feedback_endpoints(self):
        ...
        feedback_resource.add_method("POST", apigw.LambdaIntegration(self.feedback_lambda))
